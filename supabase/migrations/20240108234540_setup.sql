...
AS $$
DECLARE
  project_url TEXT := 'https://kkbaptipyrvcsdhgwimu.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtrYmFwdGlweXJ2Y3NkaGd3aW11Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0MDMzNTEwOSwiZXhwIjoyMDU1OTExMTA5fQ.Pzmu4Lsskr8QzDDvjxMeP3kuEucq_m0KMf5Xkk1LgN0'; -- full access needed for http request to storage
